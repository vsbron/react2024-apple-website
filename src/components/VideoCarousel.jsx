...
function VideoCarousel() {
  ...
  // Setting the state for the video
  ...
  // Destructuring ths state value
  const { isEnd, isLastVideo, startPlay, videoId, isPlaying } = video;

  // Setting the state for loaded videos array
  ...
  // useEffect for the current video progress
  useEffect(() => {
  ...
  // Handle process click handler with switch statement
